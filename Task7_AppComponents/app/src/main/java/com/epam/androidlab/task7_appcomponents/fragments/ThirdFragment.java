...
/**
 * This fragment contains button, on click on which this fragment destroys.
 */
public class ThirdFragment extends Fragment implements View.OnClickListener, ColorGenerator, Loggable {

    private static final String FRAGMENT_NAME = " Third Fragment: ";
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        Button btnDestroyFragment = view.findViewById(R.id.btnDestroyFragment);
        btnDestroyFragment.setOnClickListener(this);
    }
